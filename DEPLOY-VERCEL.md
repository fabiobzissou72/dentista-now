...
2. Selecione o repositório: **`vincedentista`**
3. Clique em **"Import"**
...
```
https://vincedentista.vercel.app
```
...
2. Adicione: `https://vincedentista.vercel.app`
...
Agora seu sistema Vince Dentista está no ar e acessível de qualquer lugar! 🎉

**URLs importantes:**
- 🌐 Frontend: `https://vincedentista.vercel.app`
- 🔐 Login: `https://vincedentista.vercel.app/login`
- 📊 Dashboard: `https://vincedentista.vercel.app/dashboard`
- 🔌 API: `https://vincedentista.vercel.app/api/*`
