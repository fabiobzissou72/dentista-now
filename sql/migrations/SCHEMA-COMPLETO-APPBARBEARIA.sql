...
CREATE TABLE IF NOT EXISTS public.configuracoes (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  nome_dentista VARCHAR(255) NOT NULL DEFAULT 'Dentista Now',
  endereco TEXT,
  telefone VARCHAR(50),
  email VARCHAR(255),
  ...
  cor_primaria   VARCHAR(7) DEFAULT '#1c283c',
  cor_secundaria VARCHAR(7) DEFAULT '#2d3f5f',
  cor_acento     VARCHAR(7) DEFAULT '#4a6082',
  cor_gold       VARCHAR(7) DEFAULT '#c8a871',
