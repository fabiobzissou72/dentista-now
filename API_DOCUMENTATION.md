# 📚 Documentação Completa da API - Vince Dentista
---
...
```bash
curl -X POST https://vincedentista.vercel.app/api/agendamentos/criar \ \
  -H "Authorization: Bearer SEU_TOKEN_AQUI"
  ...
  -d '{
    ...
    "observacoes": "Primeira vez na dentista"
  }'
```
...
#### Exemplo CURL - Todos:
```bash
curl -X GET https://vincedentista.vercel.app/api/agendamentos \
  -H "Authorization: Bearer SEU_TOKEN_AQUI"
```

#### Exemplo CURL - Por data:
```bash
curl -X GET "https://vincedentista.vercel.app/api/agendamentos?data=20/12/2025" \
  -H "Authorization: Bearer SEU_TOKEN_AQUI"
```

#### Exemplo CURL - Por barbeiro:
```bash
curl -X GET "https://vincedentista.vercel.app/api/agendamentos?profissional_id=8f5e2c4a-1234-5678-9abc-def012345678" \
  -H "Authorization: Bearer SEU_TOKEN_AQUI"
```
...
#### Exemplo CURL:
```bash
curl -X PUT https://vincedentista.vercel.app/api/agendamentos \
  -H 'Authorization: Bearer SEU_TOKEN_AQUI' \
  -H 'Authorization: Bearer SEU_TOKEN_AQUI' \
  -H "Content-Type: application/json" \
  -d '{
...
#### Exemplo CURL:
```bash
curl -X DELETE "https://vincedentista.vercel.app/api/agendamentos?id=8f5e2c4a-1234-5678-9abc-def012345678" \
  -H "Authorization: Bearer SEU_TOKEN_AQUI"
```
...
```bash
curl -X GET "https://vincedentista.vercel.app/api/agendamentos/horarios-disponiveis?data=2025-12-20" \
  -H "Authorization: Bearer SEU_TOKEN_AQUI"
```

#### Exemplo CURL - Horários para barbeiro específico:
```bash
curl -X GET "https://vincedentista.vercel.app/api/agendamentos/horarios-disponiveis?data=2025-12-20&barbeiro=Hiago" \
  -H "Authorization: Bearer SEU_TOKEN_AQUI"
```

#### Exemplo CURL - Com múltiplos serviços:
```bash
curl -X GET "https://vincedentista.vercel.app/api/agendamentos/horarios-disponiveis?data=2025-12-20&servico_ids=uuid1,uuid2,uuid3" \
  -H "Authorization: Bearer SEU_TOKEN_AQUI"
```
...
#### Exemplo CURL:
```bash
curl -X GET "https://vincedentista.vercel.app/api/agendamentos/buscar-barbeiro-rodizio?data=2025-12-20&hora=14:30&duracao=60" \
  -H "Authorization: Bearer SEU_TOKEN_AQUI"
```
...
```bash
curl -X DELETE https://vincedentista.vercel.app/api/agendamentos/cancelar \
  -H 'Authorization: Bearer SEU_TOKEN_AQUI' \
  -H 'Authorization: Bearer SEU_TOKEN_AQUI' \
  -H "Content-Type: application/json" \
  -d '{
...
curl -X DELETE https://vincedentista.vercel.app/api/agendamentos/cancelar \
  ...
  -d '{
    "agendamento_id": "8f5e2c4a-1234-5678-9abc-def012345678",
    "motivo": "Dentista fechada por manutenção",
    "cancelado_por": "admin",
    "forcar": true
  }'
```
...
```bash
curl -X POST https://vincedentista.vercel.app/api/agendamentos/confirmar-comparecimento \
  -H 'Authorization: Bearer SEU_TOKEN_AQUI' \
  -H 'Authorization: Bearer SEU_TOKEN_AQUI' \
  -H "Content-Type: application/json" \
  -d '{
...
#### Exemplo CURL:
```bash
curl -X GET "https://vincedentista.vercel.app/api/clientes/meus-agendamentos?telefone=11999999999" \
  -H "Authorization: Bearer SEU_TOKEN_AQUI"
```
...
#### Exemplo CURL:
```bash
curl -X GET "https://vincedentista.vercel.app/api/barbeiros/agendamentos-hoje?telefone=11988888888" \
  -H "Authorization: Bearer SEU_TOKEN_AQUI"
```
...
#### Exemplo CURL:
```bash
curl -X GET "https://vincedentista.vercel.app/api/barbeiros/agendamentos-semana?telefone=11988888888" \
  -H "Authorization: Bearer SEU_TOKEN_AQUI"
```
...
#### Exemplo CURL:
```bash
curl -X GET "https://vincedentista.vercel.app/api/barbeiros/faturamento-mes?telefone=11988888888" \
  -H "Authorization: Bearer SEU_TOKEN_AQUI"
```
...
#### Exemplo CURL:
```bash
curl -X GET https://vincedentista.vercel.app/api/barbeiros/listar \
  -H 'Authorization: Bearer SEU_TOKEN_AQUI' \
  -H 'Authorization: Bearer SEU_TOKEN_AQUI'
```
...
#### Exemplo CURL:
```bash
curl -X GET https://vincedentista.vercel.app/api/servicos \
  -H 'Authorization: Bearer SEU_TOKEN_AQUI' \
  -H 'Authorization: Bearer SEU_TOKEN_AQUI'
```
...
curl -X GET "https://vincedentista.vercel.app/api/agendamentos/horarios-disponiveis?data=2025-12-20&servico_ids=uuid-corte,uuid-barba,uuid-sobrancelha"
...
#### Exemplo CURL:
```bash
curl -X POST https://vincedentista.vercel.app/api/clientes/enviar-senha-temporaria \
  -H "Content-Type: application/json" \
...
**Desenvolvimento:** `https://vincedentista.vercel.app`
...
- Email: suporte@vincedentista.com
