...
**Vince Dentista - API para IA/WhatsApp**
...
**Exemplo cURL:**
```bash
curl -X GET 'https://vincedentista.vercel.app/api/barbeiro/agendamentos?barbeiro=Hiago&quando=hoje' \
...
**Exemplo cURL:**
```bash
curl -X GET 'https://vincedentista.vercel.app/api/barbeiros/meu-faturamento?barbeiro_nome=Hiago&periodo=hoje' \
  -H 'accept: application/json' \
  -H 'Authorization: Bearer SEU_TOKEN_AQUI'
```
...
**Exemplo cURL:**
```bash
curl -X GET 'https://vincedentista.vercel.app/api/barbeiros/faturamento-mes?barbeiro_nome=Hiago&mes=01&ano=2026' \
  -H 'accept: application/json' \
  -H 'Authorization: Bearer SEU_TOKEN_AQUI'
```
...
**Exemplo cURL:**
```bash
curl -X GET 'https://vincedentista.vercel.app/api/barbeiros/horarios' \
  -H 'accept: application/json' \
  -H 'Authorization: Bearer SEU_TOKEN_AQUI'
```
