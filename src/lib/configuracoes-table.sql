-- Criação da tabela de configurações da dentista
create table if not exists public.configuracoes (
  id uuid not null default gen_random_uuid(),
  nome_dentista character varying(255) not null default 'Vince Dentista',
  endereco text null,
...
comment on table public.configuracoes is 'Armazena as configurações gerais da dentista';
