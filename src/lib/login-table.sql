...
((SELECT id FROM profissionais WHERE nome = 'Hiago' LIMIT 1), 'hiago@vincedentista.com', '123456'),
((SELECT id FROM profissionais WHERE nome = 'Alex' LIMIT 1), 'alex@vincedentista.com', '123456'),
((SELECT id FROM profissionais WHERE nome = 'Filippe' LIMIT 1), 'filippe@vincedentista.com', '123456');
*/