# 📚 Documentação Completa da API - Vinci Dentista
...
#### Exemplo CURL:
```bash
curl -X POST https://vincidentista.vercel.app/api/clientes/enviar-senha-temporaria \
  -H "Content-Type: application/json" \
...
- Email: suporte@vincidentista.com
