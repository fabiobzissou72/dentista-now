...
```bash
curl "https://vincidentista.vercel.app/api/barbeiros/meus-agendamentos?barbeiro_nome=Hiago&periodo=hoje"
```

### cURL - Agendamentos da SEMANA:
```bash
curl "https://vincidentista.vercel.app/api/barbeiros/meus-agendamentos?barbeiro_nome=Hiago&periodo=semana"
```

### cURL - Agendamentos do MÊS:
```bash
curl "https://vincidentista.vercel.app/api/barbeiros/meus-agendamentos?barbeiro_nome=Hiago&periodo=mes"
```
...
```bash
curl "https://vincidentista.vercel.app/api/barbeiros/meu-faturamento?barbeiro_nome=Hiago&periodo=hoje"
```

### cURL - Faturamento da SEMANA:
```bash
curl "https://vincidentista.vercel.app/api/barbeiros/meu-faturamento?barbeiro_nome=Hiago&periodo=semana"
```

### cURL - Faturamento do MÊS:
```bash
curl "https://vincidentista.vercel.app/api/barbeiros/meu-faturamento?barbeiro_nome=Hiago&periodo=mes"
```
...
```bash
curl -X POST https://vincidentista.vercel.app/api/barbeiros/cancelar-meu-agendamento \
...
{
  "method": "GET",
  "url": "https://vincidentista.vercel.app/api/barbeiros/meus-agendamentos",
  "qs": {
...
{
  "method": "GET",
  "url": "https://vincidentista.vercel.app/api/barbeiros/meu-faturamento",
  "qs": {
    "barbeiro_nome": "{{ $json.barbeiro }}",
    "periodo": "{{ $json.periodo }}"
  }
