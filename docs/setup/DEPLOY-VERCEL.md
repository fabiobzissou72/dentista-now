...
2. Selecione o repositório: **`vincidentista`**
3. Clique em **"Import"**
...
2. Adicione: `https://vincidentista.vercel.app`
...
**URLs importantes:**
- 🌐 Frontend: `https://vincidentista.vercel.app`
- 🔐 Login: `https://vincidentista.vercel.app/login`
- 📊 Dashboard: `https://vincidentista.vercel.app/dashboard`
- 🔌 API: `https://vincidentista.vercel.app/api/*`
